...
export async function loadPublicProvider(provider) {
  ...
  try {
    ...
    if (source.mode === 'azure-status-html') return await parseAzureEntraSource(provider, source);
